        ...
        public void Activate(PuzzleChoices puzzzleChoices, ScenarioStage scenarioStage, Sprite[] grids, TypeDifficulty typeDifficulty)
        {
            ...
            switch (typeDifficulty)
            {
                case TypeDifficulty.Easy:
                    ...
                    _buttonPlay.onClick.AddListener(() => puzzzleChoices.StartGameplay(scenarioStage.easyValueX, GameData.Details.chanceEasy));
                    break;
                case TypeDifficulty.Medium:
                    ...
                    _buttonPlay.onClick.AddListener(() => puzzzleChoices.StartGameplay(scenarioStage.mediumValueX, GameData.Details.chanceMedium));
                    break;
                case TypeDifficulty.Hard:
                    ...
                    _buttonPlay.onClick.AddListener(() => puzzzleChoices.StartGameplay(scenarioStage.hardValueX, GameData.Details.chanceHard));
                    break;
                default:
                    break;
            }
