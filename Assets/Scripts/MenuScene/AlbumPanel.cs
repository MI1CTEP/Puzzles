...
namespace MyGame.Menu
{
    public sealed class AlbumPanel : MenuPanel
    {
        ...
        {
            "ƒл€ открыти€ карточки пройдите уровень!",
            "ƒл€ открыти€ карточки пройдите все этапы пазла на легком уровне сложности!",
            "ƒл€ открыти€ карточки подарите простой подарок!",
            "ƒл€ открыти€ карточки подарите хороший подарок!",
            "ƒл€ открыти€ карточки пройдите все этапы пазла на среднем уровне слодности!",
            "ƒл€ открыти€ карточки подарите ценный подарок!",
            "ƒл€ открыти€ карточки пройдите уровнень на минимальный уровень симпатии!",
            "ƒл€ открыти€ карточки пройдите все этапы пазла на высоком уровне слодности!",
            "ƒл€ открыти€ карточки пройдите уровнень на максимальный уровень симпатии!",
            "ƒл€ открыти€ карточки подарите дорогой подарок!"
        };
    }
}